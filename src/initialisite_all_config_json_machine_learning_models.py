...
initial_dict_parameters = {
    ...
    'df_resampled_interpolated_resample_freq': '60S', 
    'df_resampled_interpolated_aggregation_func': 'mean', 
    'df_resampled_interpolated_method': 'linear', 
    'df_resampled_interpolated_outlier_cols': None, 
